...
**Note:** Most of these functions don't just generate the figures with pre-analyzed data; wherever possible, I have uploaded the raw data and analysis code. Please [email me](mailto:ramsrinath@uchicago.edu) if you find missing dependencies or need access to even raw-er data like spike times or LFP data. The data release has additionally been deposited/archived at https://doi.org/10.5281/zenodo.20347874.
