...
function plotGenDec_marg(cVals)
    ...
    line([mean(x(t==1)) mean(x(t==1))],[30 120],'linewidth',2,'color',cols{1},'linestyle','--')
    line([mean(x(t==2)) mean(x(t==2))],[30 120],'linewidth',2,'color',cols{2},'linestyle','--')
    line([mean(x(t==3)) mean(x(t==3))],[30 120],'linewidth',2,'color',cols{3},'linestyle','--')
    ...
    line([mean(y(t==1)) mean(y(t==1))],[30 120],'linewidth',2,'color',cols{1},'linestyle','--')
    line([mean(y(t==2)) mean(y(t==2))],[30 120],'linewidth',2,'color',cols{2},'linestyle','--')
    line([mean(y(t==3)) mean(y(t==3))],[30 120],'linewidth',2,'color',cols{3},'linestyle','--')
    line([0 0],[0 120],'linewidth',2,'color','k','linestyle','--')
    view([90 -90])
    fixPlot(gca,[-0.1 1],[0 40],'','',-1:0.5:1,0:30:200); set(gca,'XTickLabel',{})
