...
function plotGenError(rec)
    ...
    subplot(221); hold on;
    histogram(x(t==1),linspace(-0.5,1,20),'DisplayStyle','stairs','EdgeColor',cols{1},'LineWidth',2);
    histogram(x(t==2),linspace(-0.5,1,20),'DisplayStyle','stairs','EdgeColor',cols{2},'LineWidth',2);
    histogram(x(t==3),linspace(-0.5,1,20),'DisplayStyle','stairs','EdgeColor',cols{3},'LineWidth',2);
    ...
    fixPlot(gca,[-0.5 1],[0 60],'','',-1:0.5:1,0:30:200); set(gca,'XTickLabel',{})
    
    subplot(224); hold on;
    histogram(y(t==1),linspace(-0.5,1,20),'DisplayStyle','stairs','EdgeColor',cols{1},'LineWidth',2);
    histogram(y(t==2),linspace(-0.5,1,20),'DisplayStyle','stairs','EdgeColor',cols{2},'LineWidth',2);
    histogram(y(t==3),linspace(-0.5,1,20),'DisplayStyle','stairs','EdgeColor',cols{3},'LineWidth',2);
    ...
    fixPlot(gca,[-0.5 1],[-0.5 1],'shape specific','shape general',-1:0.5:1,-1:0.5:1)
